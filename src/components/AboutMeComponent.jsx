        ...
        <article className="aboutMeContainer">
            <div className="left-about">
                <p className="main-para-about">
                    ...
                    My journey in the world of coding began with Python, which was my first programming language. 
                    As I delved deeper into the realm of coding, I expanded my skill set to include JavaScript, HTML5, and CSS3, 
                    allowing me to create dynamic web applications and websites.
                </p>
                <p className="main-para-about">
                    ...
                    where I utilized Python frameworks like BeautifulSoup (bs4), Selenium, and Pandas. 
                ...
                <p className="main-para-about">
                    ...
                    On the back-end, I've worked with Django Rest Framework in Python and Node.js with Express.js, enabling me to build robust and scalable web applications.
                </p>
                <p className="main-para-about">
                    One of my favorite tools in the front-end development arsenal is
                    React.js
                    , which I've used to create dynamic and responsive user interfaces. This framework has opened up endless possibilities for crafting engaging web experiences.
                </p>
                <p className="main-para-about">
                    When it comes to data storage, I'm well-versed in
                    PostgreSQL
                    , a powerful relational database management system that complements my skill set perfectly.
                </p>
                <p className="main-para-about">
                Outside the exhilarating world of coding, I have a variety of hobbies and interest that keep me balanced and engaged in life. 
                One of my favorite past-times is playing chess, playing computer games(strategy games, moba, shooter, rpg)
                </p>
                <p className="main-para-about">
